#ifndef SPARSEDELAYNEURALFIELDHEADERDEF
#define SPARSEDELAYNEURALFIELDHEADERDEF
...
class SparseDelayNeuralField : public SparseDDEInterface
{
public:
 	// Constructor takes in parameters, connectivity matrix and mesh
  	SparseDelayNeuralField(const arma::vec& parameters, arma::mat& connectivity, Mesh& mesh);
